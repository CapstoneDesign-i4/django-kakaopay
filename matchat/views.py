...
from chatbot.dialogflowApi import batch_update_intents
...
def pay(request, product_id):
    ...
    if request.method == "POST":
        ...
        params = {
            ...
            "approval_url": "http://ec2-3-39-141-76.ap-northeast-2.compute.amazonaws.com:8080/matchat/pay/approval",
            "cancel_url": "http://ec2-3-39-141-76.ap-northeast-2.compute.amazonaws.com:8080/matchat/pay/cancel",
            "fail_url": "http://ec2-3-39-141-76.ap-northeast-2.compute.amazonaws.com:8080/matchat/pay/fail",
        }
