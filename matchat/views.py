...
def pay(request, product_id):
    ...
    if request.method == "POST":
        ...
        params = {
            ...
            "approval_url": "http://www.matchat.shop/matchat/pay/approval",
            "cancel_url": "http://www.matchat.shop/matchat/pay/cancel",
            "fail_url": "http://www.matchat.shop/matchat/pay/fail",
        }
